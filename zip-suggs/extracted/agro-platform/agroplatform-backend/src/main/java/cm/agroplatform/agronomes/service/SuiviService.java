...
public class SuiviService {
    ...
    public void notifierAgronomeNouvelledemande(Long agronomeId, String agriculteurNom) {
        ...
        payload.put("type",             "NOUVELLE_DEMANDE_SUIVI");
        payload.put("destinataireType", "AGRONOME");
        payload.put("destinataireId",   agronomeId.toString());
        payload.put("titre",            "Nouvelle demande de suivi");
        payload.put("message",          agriculteurNom + " vous a envoyé une demande de suivi.");
        payload.put("createdAt",        LocalDateTime.now().toString());

        messagingTemplate.convertAndSend("/topic/notifications." + agronomeId, (Object) payload);
    }
    ...
    /**
     * @Async — notifie l'agriculteur de la réponse sans bloquer.
     */
    @Async("agroTaskExecutor")
    public void notifierAgriculteurReponse(Long agriculteurId, StatutSuivi statut) {
        ...
        Map<String, String> payload = new HashMap<>();
        payload.put("type",             "REPONSE_DEMANDE_SUIVI");
        payload.put("destinataireType", "AGRICULTEUR");
        payload.put("destinataireId",   agriculteurId.toString());
        payload.put("statut",           statut.name());
        payload.put("titre",            "Réponse à votre demande de suivi");
        payload.put("message",          "Votre demande de suivi a été " + statut.name().toLowerCase() + ".");
        payload.put("createdAt",        LocalDateTime.now().toString());

        messagingTemplate.convertAndSend("/topic/notifications." + agriculteurId, (Object) payload);
    }
