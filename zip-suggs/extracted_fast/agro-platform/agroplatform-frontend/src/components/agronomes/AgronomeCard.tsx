      ...
      <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
            ...
            {/* Nom cliquable */}
            <button
              onClick={() => onVoirProfil(agronome.id)}
              style={{
                background: 'none', border: 'none', padding: 0,
                cursor: 'pointer', fontSize: 15, fontWeight: 500,
                color: 'var(--agro-text-primary)', textAlign: 'left',
                fontFamily: 'inherit',
              }}
              onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = 'var(--agro-green-dark)'; }}
              onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = 'var(--agro-text-primary)'; }}
            >
